...
(function () {
  ...
  style.textContent = [
    '#ss-bubble{position:fixed;bottom:22px;right:22px;width:60px;height:60px;border-radius:50%;background:linear-gradient(135deg,#0B1F3A 0%,#1FA69F 100%);box-shadow:0 4px 14px rgba(11,31,58,0.35);cursor:pointer;z-index:2147483640;display:flex;align-items:center;justify-content:center;transition:transform .15s ease;border:none}',
    '#ss-bubble:hover{transform:scale(1.05)}',
    '#ss-bubble svg{width:28px;height:28px;fill:#fff}',
    '#ss-badge{position:absolute;top:-4px;right:-4px;background:#1FA69F;color:#fff;font-size:10px;font-weight:700;padding:2px 6px;border-radius:10px;font-family:-apple-system,Inter,Arial,sans-serif}',
    '#ss-panel{position:fixed;bottom:90px;right:22px;width:380px;max-width:calc(100vw - 44px);height:560px;max-height:calc(100vh - 120px);background:#fff;border-radius:14px;box-shadow:0 12px 40px rgba(11,31,58,0.25);z-index:2147483641;display:none;flex-direction:column;overflow:hidden;font-family:-apple-system,Inter,Segoe UI,Arial,sans-serif}',
    '#ss-panel.ss-open{display:flex}',
    '#ss-header{background:linear-gradient(135deg,#0B1F3A 0%,#1FA69F 100%);color:#fff;padding:14px 16px;display:flex;align-items:center;justify-content:space-between}',
    ...
    '.ss-msg-user{align-self:flex-end;background:#1FA69F;color:#fff;border-bottom-right-radius:4px}',
    '.ss-msg-bot{align-self:flex-start;background:#fff;color:#111827;border:1px solid #E5E7EB;border-bottom-left-radius:4px}',
    '.ss-msg-bot a{color:#1FA69F;text-decoration:underline}',
    ...
    '#ss-input:focus{border-color:#1FA69F;box-shadow:0 0 0 3px rgba(31,166,159,.15)}',
    '#ss-send{background:#0B1F3A;color:#fff;border:none;border-radius:10px;padding:0 16px;cursor:pointer;font-weight:600;font-size:14px}',
    '#ss-send:hover{background:#1FA69F}',
    ...
    '#ss-footer a{color:#1FA69F;text-decoration:none}',
